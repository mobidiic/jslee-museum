...
import { wrapDisplayName, compose, shallowEqual } from 'recompose';
import { camelCase, difference, pick, isEmpty, debounce } from 'lodash';
    ...
    createClass(NaverEvents, [{
      ...
      value: function generateListenerNames() {
        this.listenerNames = this.props.naverEventNames.map(function (naverEventName) {
          ...
          var camelEventName = camelCase(naverEventName);

          // propsListener is event listener defined on props. (user input)
          var propsListenerName = camelCase('on_' + naverEventName);
      ...
      value: function updateListeners() {
        ...
        var orphanListenerNames = difference(beforeListenerNames, currentListenerNames);
...
var NaverMap = compose(namedWrapper('NaverMap'), withNavermaps(), withNaverInstanceRef, withNaverMapInstance, withNaverEvents)(NaverMapDom);
  ...
  var MarkerInstance = function (_React$Component) {
    ...
    createClass(MarkerInstance, [{
      ...
      value: function shouldComponentUpdate(nextProps) {
        ...
        var equality = shallowEqual(restCurrentProps, restNextProps) && coordEquals(currentPosition, nextPosition) && iconEquals$1(currentIcon, nextIcon);
...
var Marker = compose(namedWrapper('NaverMarker'), withNavermaps(), withMarkerInstance, withNaverEvents)(function NaverMarkerDOM() {
  return null;
});
...
var Panorama = compose(namedWrapper('NaverPanorama'), withNavermaps({ submodules: ['panorama'] }), withNaverInstanceRef, withNaverPanoramaInstance, withNaverEvents)(NaverPanoramaDOM);
...
var Polygon = compose(withNavermaps(), withMap, withPolygonKVO, withNaverEvents)(function PolygonDOM() {
...
export { NaverMap as Map, MarkerWithContext as Marker, Panorama, Polygon, withNavermaps, withNaverEvents, withMap, loadNavermapsScript };
